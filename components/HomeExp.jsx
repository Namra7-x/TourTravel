...
const HomeExp = ({ videoSrc = "https://framerusercontent.com/assets/vcDo4jaVBqJXArUO9845j1SDy8.mp4" }) => {
    ...
    useEffect(() => {
        ...
        const intervalId = window.setInterval(() => {
            ...
            const nextLeft = carousel.scrollLeft + carousel.clientWidth;
            carousel.scrollTo({
    ...
    return (
        <>
            ...
            >
                <motion.header variants={fadeInUp} custom={0}>
                ...
                <motion.div className="my-12 px-4 sm:px-6 lg:px-10" variants={fadeInUp} custom={1}>
                    <div
                        ref={carouselRef}
                        className="flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth pb-4 sm:gap-5 lg:gap-7"
                    >
                        {reviews.map((review, idx) => (
                            <div
                                key={review.id}
                                className="h-auto min-w-0 shrink-0 basis-full snap-start sm:basis-[calc((100%_-_1.25rem)/2)] lg:basis-[calc((100%_-_3.5rem)/3)]"
                            >
                                <motion.div
                                ...
                                >
                                    ...
                                    <p className="my-5 text-sm sm:text-base lg:text-lg leading-relaxed">
                                        &quot;{review.text}&quot;
                                    </p>
                                    <motion.div
                ...
                <motion.div className="flex justify-center items-center gap-4 mt-8 px-4" variants={fadeInUp} custom={2}>
                    <motion.button
                        onClick={goPrev}
